...
public:
	...
	RenderTarget* mDepthStencilRendertarget;
...
public:
	...
	SimpleRenderer(const int& clientWidth, const int& clientHeight);
	SimpleRenderer(const SimpleRenderer& rhs) = delete;
	SimpleRenderer& operator=(const SimpleRenderer& rhs) = delete;
	~SimpleRenderer();
	...
	MaterialResource* mTestScrrenPassMaterial;
	...
	RenderTarget* mTestScreenPassRenderTarget;
